	...
	* level no-op closures that V8 reports as uncovered functions. */
	...
	return {
		...
		articleStore: {
			...
			findArticlesAcrossReadlists: articleStoreMemory.findArticlesAcrossReadlists,
			...
			findReadlistArticleById: articleStoreMemory.findReadlistArticleById,
			updateArticleStatusAcrossReadlists: articleStoreMemory.updateArticleStatusAcrossReadlists,
			deleteReadlistArticle: articleStoreMemory.deleteReadlistArticle,
			markReadlistArticleViewed: articleStoreMemory.markReadlistArticleViewed,
			listUserSavesForUrl: articleStoreMemory.listUserSavesForUrl,
			listUserSavesForUrls: articleStoreMemory.listUserSavesForUrls,
			assignSavedArticleToReadlist: articleStoreMemory.assignSavedArticleToReadlist,
			moveReadlistArticles: articleStoreMemory.moveReadlistArticles,
			createReadlistDefinition: articleStoreMemory.createReadlistDefinition,
