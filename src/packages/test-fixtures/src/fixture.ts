	...
	* level no-op closures that V8 reports as uncovered functions. */
	...
	return {
		...
		articleStore: {
			...
			saveQueueArticle: articleStoreMemory.saveQueueArticle,
			findQueueArticles: articleStoreMemory.findQueueArticles,
			countQueueArticles: articleStoreMemory.countQueueArticles,
			findQueueArticleById: articleStoreMemory.findQueueArticleById,
			updateArticleStatusAcrossQueues: articleStoreMemory.updateArticleStatusAcrossQueues,
			deleteQueueArticle: articleStoreMemory.deleteQueueArticle,
