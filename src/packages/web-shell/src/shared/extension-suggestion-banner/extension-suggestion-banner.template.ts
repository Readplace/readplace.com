    ...
    <div class="extension-suggestion-banner__content">
      ...
      {{else}}
        <p class="extension-suggestion-banner__message" data-test-extension-suggestion-variant="not-installed">
          Some sites only let me save the link, not the full article. The <a class="extension-suggestion-banner__inline" href="/install?utm_source=web-app&amp;utm_medium=banner&amp;utm_campaign=extension-suggestion&amp;utm_content=inline-text" data-test-extension-suggestion-inline>Readplace extension</a> saves the whole thing straight from your browser.
        </p>
        <a class="extension-suggestion-banner__cta" href="/install?utm_source=web-app&amp;utm_medium=banner&amp;utm_campaign=extension-suggestion&amp;utm_content=cta-button" data-test-extension-suggestion-cta>Get the extension</a>
      {{/if}}
    </div>
  </div>
</div>
