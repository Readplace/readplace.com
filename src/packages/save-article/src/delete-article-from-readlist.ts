...
export interface DeleteArticleFromReadlistDependencies {
	deleteArticle: DeleteArticle;
	findArticleUrlById: FindArticleUrlById;
	publishLinkDequeued: PublishLinkDequeued;
}

/** Drops a reader's readlist row and announces that it is gone, so every surface
 * that answers "is this in your readlist?" hears about a delete the same way it
 * hears about a save.
 *
...
export function initDeleteArticleFromReadlist(
