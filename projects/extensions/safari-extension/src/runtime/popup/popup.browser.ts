...
// safari-web-extension:// pages, so the page-level intercept can't reach here.
...
if (shortcutHint) {
	// Safari does not support navigator.userAgentData, so fall back to the
	// deprecated navigator.platform to detect macOS.
