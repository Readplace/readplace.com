 ...
 * Firefox 146: both render their native PDF viewer as an HTML document yet still
 * report contentType "application/pdf", so this one browser-agnostic check catches a native PDF tab
