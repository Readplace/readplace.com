// Measured, not chosen. 250ms is ~2.7x the slowest run mean over 20
// independent github-hosted runs (93.6ms), which is ~12 standard deviations of
...
// Chrome regression through. Re-derive with the perf soak workflow when the
// runner image, the browser, or the save path moves.
module.exports = {
  meanSaveMs: 250,
