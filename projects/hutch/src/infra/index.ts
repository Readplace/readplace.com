...
const tableNames = {
	...
	resendThrottle: config.require("dynamodbResendThrottleTable"),
...
const dynamodb = new HutchDynamoDBAccess("hutch-dynamodb-access", {
	tables: [
		...
		{ arn: storage.resendThrottleTable.arn, includeIndexes: false },
...
const lambda = new HutchLambda(LAMBDA_NAMES.hutchHandler, {
	...
	environment: {
		...
		DYNAMODB_RESEND_THROTTLE_TABLE: storage.resendThrottleTable.name,
