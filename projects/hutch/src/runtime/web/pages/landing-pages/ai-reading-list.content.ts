	...
	faq: [
		{
			...
			answer:
				"Claude through its listing in the connector directory, added in one click. ChatGPT through the official Readplace plugin, added in one click. Gemini free through the CLI, or the Gemini app with a Google AI Ultra subscription.",
		},
		{
