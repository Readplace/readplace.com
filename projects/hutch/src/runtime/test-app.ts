...
function flattenFixtureToAppDependencies(
	...
	return {
		...
		createHighlight: fixture.highlightsStore.createHighlight,
		findHighlightsByArticle: fixture.highlightsStore.findHighlightsByArticle,
		deleteHighlight: fixture.highlightsStore.deleteHighlight,
