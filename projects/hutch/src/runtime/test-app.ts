...
function flattenFixtureToAppDependencies(
	...
	return {
		...
		newsletterInboxStore: fixture.newsletter.inboxStore,
		newsletterMessageStore: fixture.newsletter.messageStore,
		fetchInboundEmail: fixture.newsletter.fetchInboundEmail,
		newsletterInboxDomain: fixture.newsletter.inboxDomain,
		resendInboundSigningSecret: fixture.newsletter.inboundSigningSecret,
