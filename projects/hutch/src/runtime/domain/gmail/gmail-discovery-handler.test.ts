...
describe("initGmailDiscoveryDlqHandler", () => {
	...
	it("ignores deleted, completed and stale generations or pages without stopping current work", async () => {
		...
		await h.discovery.savePage({ previous, senders: [], mode: "history", pageToken: undefined, historyId: "200", state: "complete", scannedMessages: 0, estimatedTotalMessages: undefined, oldestScannedAt: undefined });
