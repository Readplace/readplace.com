...
/** The readlist lists from the eventually-consistent userId-savedAt-index GSI, so a
 * save can still be propagating when the readlist is first read — a readlist that
