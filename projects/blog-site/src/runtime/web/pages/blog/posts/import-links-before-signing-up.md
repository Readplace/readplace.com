...
Two limits sit on the edge of this. A file over 4.5 MB, or an import past 2,000 links, has to be split into smaller files first. Under those bounds, the whole thing runs start to finish without anyone else touching it.
