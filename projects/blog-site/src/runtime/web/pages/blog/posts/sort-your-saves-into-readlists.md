...
date: "2026-08-31"
author: "Fayner Brack"
keywords: "organize read it later saves, multiple reading lists, reading list folders, sort saved articles into lists, readlist, pocket alternative with folders, file articles into lists, read it later organization, readplace"
tags: ["changelog"]
...
A first readlist costs 2 clicks at [readplace.com](/): 1 on the plus sign, 1 on the pencil to say what the list is for. The pile [the browser extension](https://readplace.com/install) has been building in All is ready to be split.
