...
Crawling inside the request made the save look thorough. Handing the crawl to the job that already owns it makes the save fast and fetches the page just as fresh. A readlist to watch it in starts at [readplace.com](/?utm_source=blog-re-saving-a-link-comes-back-right-away&utm_medium=internal&utm_content=home).
