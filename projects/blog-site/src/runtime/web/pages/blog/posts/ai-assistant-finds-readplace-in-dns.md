...
This builds on two things Readplace shipped already. Your assistant can [save articles through the MCP server](/blog/save-articles-with-your-ai-assistant?utm_source=blog-ai-assistant-finds-readplace-in-dns&utm_medium=internal&utm_content=post-save-articles-with-your-ai-assistant), and it reads the [discovery files](/blog/ai-agents-discover-readplace?utm_source=blog-ai-assistant-finds-readplace-in-dns&utm_medium=internal&utm_content=post-ai-agents-discover-readplace) that describe the API in plain text. The DNS records put those same tools one step closer, so the agent reaches them before it ever opens the site.

Ask your assistant to save your next article, and let it find Readplace the rest of the way. [Install the browser extension](https://readplace.com/install) or start at [readplace.com](/?utm_source=blog-ai-assistant-finds-readplace-in-dns&utm_medium=internal&utm_content=home).
