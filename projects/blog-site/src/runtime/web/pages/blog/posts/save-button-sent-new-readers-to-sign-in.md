...
There is a small link near the bottom, create one. They have to notice it, read it, and click through, after the page has told them in so many words that they are in the wrong place. Every one of those is a step where a warm reader cools off and closes the tab. The same reasoning [moved the signup form to the end of the import flow](/blog/import-links-before-signing-up) and [put the importer itself in front of the account](/blog/import-page-findable-in-search). Ask for the account when the person is ready to make one, not before they have seen a reason to.
