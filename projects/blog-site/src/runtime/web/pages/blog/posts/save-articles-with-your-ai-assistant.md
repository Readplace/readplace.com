...
The first is `save_link`. Give it a web address and it saves the page to your readlist. Articles, blog posts, and PDFs all work. The title, a short excerpt, and a clean reader view fill in a few seconds later, so the card shows up right away and finishes on its own.
