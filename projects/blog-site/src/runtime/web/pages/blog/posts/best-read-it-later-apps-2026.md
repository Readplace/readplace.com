...
- The trial takes no card and has no billing cliff: 14 days with the full product, and a lapsed trial simply goes read-only.
...
**Good fit for:** Readers on Kobo e-readers, and anyone who wants a free, simple Pocket replacement and is comfortable with the ownership-history question that comes with it.

## Raindrop.io

Raindrop.io is a bookmark manager first and a read-it-later tool second. It handles collections, nested folders, tags, and full-text search across saved pages, and the Pro tier adds an archive and a reader view. It is the right fit if your main need is organising and finding links rather than reading long-form, because the free tier works but lacks the reader view that makes it useful as a reading app.
...
- **If you mainly save articles and read them, and want a summary to tell you what deserves your time:** Readplace. It is the profile I built for.
- **If your reading feeds a note-taking system:** Readwise Reader. Little else matches its highlight sync to Obsidian or Notion, and for that workflow the $119.88/year can be worth it.
- **If you want to self-host and enjoy running your own services:** Karakeep. It is the most actively developed self-hosted option with AI features included.
- **If you read on a Kobo:** Instapaper. Mature, stable, and the free tier is genuinely usable.
...
Mozilla acquired Pocket in 2017 and let it slide down the priority list over the following years. Feature development slowed, the team was restructured, and by 2025 Pocket was in maintenance mode. That was the point at which most users started looking for somewhere else to save their reading. The lesson I took from it: a reading app's future should not depend on a parent company's priorities.
