...
tags: ["changelog"]
banner: "I made newsletters drop their links straight into your readlist"
---
...
They don't stop at a preview. Each one saves to your readlist the same way a link you paste in yourself would, crawled for a clean copy and given an AI summary. By the time you look, the 3 articles from a 14-link issue are in your readlist, ready to read, and the other 11 links are gone.

```rp-figure
kind: walk
title: What a link has to get past before it reaches your readlist
...
step: The article pass | A pass labels each link an article, an ad, a menu, a subscription page, or noise, and only the articles come through — saved to your readlist the way a link you paste in yourself would be, crawled for a clean copy and given an AI summary. | The link is dropped with the packaging and gone from your readlist, like the other 11 links in that issue, though it still shows as a card under the newsletter where you can save it by hand.
```

> **You subscribed for the articles, and the articles are what reach your readlist.**
