...
import { initReselectAfterRemovalHandler } from "./domain/remove-my-content/reselect-after-removal-handler";
...
export const handler = initReselectAfterRemovalHandler({
	selectDeps: {
