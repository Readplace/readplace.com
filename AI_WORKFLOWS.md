...
**Prompts are files, not strings.** Every Claude instruction lives in a `.md` file next to its workflow. Prompts are version-controlled, diffable, and editable without YAML escaping headaches.
